...
namespace SampleWebApp.Areas.Identity.Pages.Account
{
	...
	public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(UserManager<MongoIdentityUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            IdentityResult result = await this._userManager.ResetPasswordAsync(user, this.Input.Code, this.Input.Password);
            if (result.Succeeded)
            {
                return this.RedirectToPage("./ResetPasswordConfirmation");
            }
